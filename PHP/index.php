...
<div class="navCollection">
    ...
    <div class="collapse bg-dark" id="navbarHeader">
        ...
        <div class="row">
            ...
            <h4 style="display: inline;"><a class="text-white btn btn-primary " role ="button" href="insertGame.php" >Insert Photo</a></h4>
            </div>
        </div>
        </div>
    </div>
                ...
                echo'<div class="card mb-4 shadow-sm">';
                  echo'<img src="'; echo $imageSource; echo '"alt="Bleach" width="100%" height="350" fill="#55595c">';
                    echo'<div class="card-body">';
                        echo'<p class="card-text">'; echo $desc; echo '</p>';
                        echo'<div class="d-flex justify-content-between align-items-center">';
                        echo'<div class="btn-group">';
                            echo'<button type="button" class="btn btn-sm btn-outline-secondary"><a href="updateForm.php?id=';echo $id; echo'">View</a></button>';
